-- Initialize test database with non-superuser role for RLS testing
-- This script runs automatically when the postgres-test container starts
...
GRANT CONNECT ON DATABASE saas_test TO app_user;
...
-- Log completion
DO $$ BEGIN RAISE NOTICE 'Test database initialized with app_user role'; END $$;
